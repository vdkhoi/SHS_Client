...
public class Channel {
    ...
    public Channel(SocketChannel s) {
        ...
        try {
            ...
            this.socket.socket().setSendBufferSize(1 << 16);
            this.socket.socket().setReceiveBufferSize(1 << 16);
    ...
    public void WriteString(String s) {
        try {
            this.WriteBytes(ByteBuffer.wrap(s.getBytes("UTF-8")));
    ...
    public void ReadNumBytes(ByteBuffer b, int num) {
        while (num > 0) {
            ...
            b.put(this.recvBuf.array(), this.recvPos, cnt);
